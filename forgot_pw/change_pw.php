...
<?php
 try {
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "UPDATE users SET password = '$encrypt' WHERE id = '$id'";
        mysqli_query($conn,$sql);
        $h1 = $lang == 1 ? "$username felhasználó jelszava sikeresen megváltozott!" :"Password for account named $username has been updated successfully!";
    }
    else {
