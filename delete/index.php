...
<?php
        try {
            ...
            if ($result->num_rows > 0) {
                ...
                $h1 = $lang == 1 ? "$username nevű felhasználó sikeresen törölve!" : "Account named $username has been deleted successfully!";
            }
            else {
                $h1 = $lang == 1 ? "Felhasználó már törölve!" : "Account has already been deleted!";
            }
